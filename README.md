...
| Project 2 — K-means | Python reference/fixtures complete; native C++ next | Frozen ordered-FP32 assignment, FP64 centroid update, and readable public edge cases |
...
Python reference
  ...
  → Project 2 straightforward serial C++ [next]
```
...
03_CUDA_KMeans/                  active Project 2; Python reference, public fixtures, tests, generator; legacy prefix
