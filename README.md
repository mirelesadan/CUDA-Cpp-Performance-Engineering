...
A final Phase A validation/report pass is next. The adaptive native implementation and Projects 2–4 remain planned work.
...
| Phase A final consolidation | **Next** | Re-run the public matrix and tighten reproduction/headline reporting |
...
Python reference
  ...
  → final Phase A validation/report [next]
```
